---
title: "Week 08: Sentiment Analysis with AI"
subtitle: "Using AI APIs to create data from text"
date: "2025-05-20"
---
...
::: {.container}
::: {.hero-title}
Week 08: Sentiment Analysis with AI
:::
::: {.hero-subtitle}
...
- [How to get AI API keys](/da-knowledge/get-ai-api-key.html) (OpenAI ChatGPT and Anthropic Claude)
- **Budget:** ~$5 minimum for course exercises

**API Learning Resources:**

- [Introduction to APIs](/da-knowledge/api-use.html) - fundamental concepts
- [Calling LLM APIs from Python](/da-knowledge/llm-api-python.html) - practical Python workflow, response schemas, model choice
- [Advanced API knowledge](/da-knowledge/api-advanced.html) - how APIs work under the hood
:::
:::
...
- Combined student ratings from Assignment 7 (aggregated, anonymized)
- Domain lexicon ratings

**Data Structure:**

- **texts:** Individual interview transcripts with metadata
- **games:** Match results and context information  (soccer has 3 outcomes: win, draw, loss -- implication for result encoding)
- **ratings:** Human ratings, AI ratings, lexicon scores by text_id

**Code Examples Available:**

- [R implementation](/case-studies/interviews/code/sentiment-analysis.R) requires [API key setup in R](/case-studies/interviews/code/api-key.R)
- [Python implementation](/case-studies/interviews/code/sentiment_analysis.py)

**text and prompts**

- [sentiment guidelines](/week07/assets/sentiment-guidelines.html)

**Other**

- [More advanced knowledge on APIs](/da-knowledge/api-advanced.html)  -- *how* APIs work
...
::: {.week-card .card}
::: {.card-header}
💬 **Assignment 7 Discussion (20 min)**
:::
::: {.card-body}
...
* You can also take a pretrained LLM and continue training it on thousands of labeled review. See our example guidelines [HERE](/week07/assets/sentiment-guidelines.html)
...
- [How to use APIs](/da-knowledge/api-use.html)


**Beginner-Friendly Examples:**

- [Simple walkthrough with GDP data](/da-knowledge/walkthrough-wb-fred.html)  -- uses World Bank and FRED APIs
- [Bit harder walkthrough with football data](/da-knowledge/walkthrough-fbref.html)  -- uses FBREF soccer data. Guess the club for example.
...
::: {.callout-note icon="📝"}
## Assignment 8: Gender Classification Pipeline
...
[Full Assignment Details](../assignments/assignment_08.html){.assignment-badge}
:::
