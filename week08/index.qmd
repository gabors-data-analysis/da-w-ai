...
- [How to get AI API keys](/week08/assets/get-ai-api-key.html) (OpenAI ChatGPT and Anthropic Claude)
- **Budget:** ~$5 minimum for course exercises

**API Learning Resources:**

- [Introduction to APIs](/week08/assets/api-use.html) - fundamental concepts
- [Advanced API knowledge](/week08/assets/api-advanced.html) - how APIs work under the hood
:::
:::
