...
- [`pyfixest`](https://github.com/py-econometrics/pyfixest) — general regression package with options for  [difference in differences at](https://pyfixest.org/tutorials/difference-in-differences.html#event-study-under-staggered-adoption-via-feols-event_study-did2s-lpdid)
...
- Use the `AI-interviews-me technique` to better understand the setup and what you expect, and what are you key modelling choices.
...
5. **Test additional econometric model** -- think about time, dynamics. Carefully interact with AI to pick one or two extra model. 
