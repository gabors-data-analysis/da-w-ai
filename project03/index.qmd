...
- ☐ **Review terms** — difference-in-differences, parallel trends, event-study, two-way fixed effects, staggered treatment ([glossary](../da-knowledge/technical-terms-page.qmd)). You saw these in [Week 4 — Econometrics with AI](../unit4/index.qmd).
...
- **What:**
  ...
  - GitHub repo that allows reproduction --- see [Reproducible Research](../da-knowledge/reproducible-research.qmd)).
