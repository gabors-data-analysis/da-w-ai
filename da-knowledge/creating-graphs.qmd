...
* [ChatGPT](/week06/assets/variable-dictionary-chatgpt.html) created a table, yes.
* But [look at what Claude did](/week06/assets/variable-dictionary-claude4.html), amazing.
...
```{=html}
<iframe src="../week06/assets/cps-earnings-plot.html" width="100%" height="800" frameborder="0"></iframe>
```
