...
Save this file as `morg-2014-emp-state5.csv`. You can also find it in the [US Earnings case study](/case-studies/earnings/data/morg-2014-emp-state5.csv)
...
* [ChatGPT](/da-knowledge/assets/variable-dictionary-chatgpt.html) created a table, yes.
* But [look at what Claude did](/da-knowledge/assets/variable-dictionary-claude4.html), amazing.
...
![The graph I created](../images/earnings-by-gender.png)
...
![The graph I created](../images/earnings-by-gender-age1.png)
...
```{=html}
<iframe src="assets/cps-earnings-plot.html" width="100%" height="800" frameborder="0"></iframe>
```
