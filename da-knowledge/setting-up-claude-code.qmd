...
**New to the terminal?** Check out [Terminal Basics](terminal-basics.html) first.

**Want alternatives?** See [Installing AI CLI Tools](install-cli.html) for Gemini CLI, Codex CLI, and more.
