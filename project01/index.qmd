...
- Before you start, we'll go over the companion page **[Designing Larger Analytics Projects with AI](../da-knowledge/designing-projects.qmd)** — it covers the mindsets, self-interview, `agents.md` file, and the three kinds of tests you'll use all three weeks.
...
| Week 1, 2 deliverable | Data, scripts, reproducible repo and READMEs |
| Week 3 | Full project repo + ~12-minute presentation |
