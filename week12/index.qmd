---
title: "Week 12: Zero to Hero Data Hack — From Text to Expectations"
...
:::::: {.container}
::: {.hero-title}
Week 12: From Text to Expectations
:::

::: {.hero-subtitle}
Session 2 of the Zero-to-Hero Data Hack — scrape, call an API, score expectations
:::
::::::
:::::::
...
- **Week 11 →** you have a cleaned match + manager-change dataset.
- **Week 12 (today) →** for each manager change, you build a **news-based expectation signal**: was the incoming manager received positively or negatively *before* the performance shows up on the pitch?
- **Week 13 →** you use that signal as a moderator in the DiD analysis.
...
## APIs: what you need this week

APIs come up twice in this session: **news/data APIs** (to get articles) and **LLM APIs** (to classify them). You already saw these referenced in [Week 08](../week08/index.qmd); the essentials move here.
...
- **Get an API key** (OpenAI, Anthropic, or similar): [How to get AI API keys](../week08/assets/get-ai-api-key.qmd).
...
- [Introduction to APIs](../week08/assets/api-use.qmd) — what an API call is, headers, auth, rate limits.
- [How APIs work under the hood](../week08/assets/api-advanced.qmd) — idempotency, retries, batching, tokens.
- [Simple walkthrough: World Bank + FRED](../week08/assets/walkthrough-wb-fred.qmd) — public data APIs.
- [Football-data walkthrough (FBref)](../week08/assets/walkthrough-fbref.qmd) — scraping a sports data source.
...
- Output: a small table keyed on `(team, change_date)` ready to merge into the Week 13 DiD.
...
- **Into Week 13** — Is your `(team, change_date) → expectation_score` table ready to merge into the panel?
...
- **Who:** by **group** — continue with your Week 11 team and repo; finish what you started in the session.
