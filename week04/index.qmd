...
* Download `data-modified.zip` from the [Austrian Hotels case study](/case-studies/austria-hotels/).  Unzip. It is a set of csv files such as 'cities_modified'
  * Also available on Moodle
* The data [description is available here](/case-studies/austria-hotels/data/hotel-data-readme.md) -- have a look before class
