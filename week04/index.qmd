...
1. Copy CSV/code → Paste to ChatGPT
2. Upload files directly - expensive for free plans
3. See error → Copy error → Paste back to ChatGPT
4. Repeat...
...
Ask claude code to set up a data analysis project folder with data already there.
...
::: {.week-card .card}
::: {.card-header}
**Part 3: Hands-on - Explore the Dataset (25 min)**
:::
::: {.card-body}
...
### Exercise 1: Understand the Data (Individual, 20 min)
...
### Exercise 2: What is possible Class discussion, 10 min)
...
::: {.week-card .card}
::: {.card-header}
**Part 4: Hands-on - Explore the Dataset (25 min)**
:::
::: {.card-body}
...
::: {.week-card .card}
::: {.card-header}
**Part 5: Generate New Data (30 min)**
:::
::: {.card-body}
