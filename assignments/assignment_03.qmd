...
* Once you have a draft, Upload some [data analysis slides](https://gabors-data-analysis.com/chapters/).  and ask to follow it and revise report. 
...
3. Text: What advice would you give to a fellow data analysis student on using AI to create a report?  (lastname_firstname_dawai_week03_advice.txt) (4p) -- List 2–3 pieces of advice based on your own experience using AI for this specific task. Discuss also the role of adding material. 
