...
* First, consider the VWS Survey we used in class: [Codebook](/data/VWS/codebook.pdf), [sample data](/data/WVS_random_subset2000.csv) Link it to your AI. (Can move to google drive. )
