...
- ☐ **Read** — skim [Introduction to APIs](../da-knowledge/api-use.qmd) if APIs are new.
- ☐ **Review terms** — rate limits, scraping etiquette ([glossary](../da-knowledge/technical-terms-page.qmd)).
...
APIs come up twice in this session: **news/data APIs** (to get articles) and **LLM APIs** (to classify them). You already saw these in [Week 5 — Text as Data](../unit5/index.qmd); the key references are in the [Knowledge Base](../navbar/resources.html).
