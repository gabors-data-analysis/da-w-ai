...
* Download the [WVS_GDP_merged_data.csv](/case-studies/VWS/data/WVS_GDP_merged_data.csv) from the [World Values Survey case study](/case-studies/VWS/). This is an aggregated, cleaned subset of the 7th Wave of WVS dataset merged with GDP data from World Bank
