...
- Set up project-specific instructions with `CLAUDE.md` / `GEMINI.md` / `AGENTS.md`
...
**Codex equivalent:** `AGENTS.md` -- same concept for project-level instructions.
...
- What instructions would you put in your `CLAUDE.md` / `AGENTS.md` for your thesis/project?
