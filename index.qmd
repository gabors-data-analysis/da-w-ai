...
There are three **case studies** that we use: (1) a simulated set of data tables on hotels in Austria, (2) the World Values Survey, and (3) a series of interview texts. The course ends with a capstone team project on football manager changes. 

The course material includes weekly practice **assignments**. It ends with a three-part **capstone project** designed for small teams over three weeks. 

It also has a learning more collection -- to see what is [beyond core material](da-knowledge/beyond.html) with blogs, papers, and video recommendations.
