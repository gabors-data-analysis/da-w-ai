...
- **Week 6:** From Data to Report -- vibe report vs. economics-quality report with CPS earnings data
...
See [my take on current models](da-knowledge/which-ai.html). As of *May 2025*. 
...
### Zero to Hero Data Hack (Weeks 11–13)
...
**Week 11**: Project intro + data collection & description — [Content](week11/)

**Week 12**: From text to expectations (scraping + LLM APIs) — [Content](week12/)

**Week 13**: Difference-in-Differences analysis + final presentation — [Content](week13/)
