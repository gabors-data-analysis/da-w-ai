---
title: "Week 07: using text as data"
...
- [Student test file (CSV)](/week07/assets/student_test_5.csv)
- [Student test file (Excel)](/week07/assets/student_test_5.xlsx)

**Reference Materials:**

- [General sentiment rating scale](/week07/assets/sentiment-scale.html) - our classification framework
...
- **Individual work:** Rate the 5 provided manager statements using the [sentiment scale](/week07/assets/sentiment-scale.html)
...
- Examine the [football-specific lexicon](/case-studies/interviews/data/domain_lexicon.csv)
...
::: {.callout-note icon="📝"}
## Assignment 7: Student-Specific Sentiment Analysis
