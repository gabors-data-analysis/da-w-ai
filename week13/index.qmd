---
title: "Week 13: Zero to Hero Data Hack — Difference-in-Differences & Final Report"
...
:::::: {.container}
::: {.hero-title}
Week 13: DiD Analysis & Final Presentation
:::

::: {.hero-subtitle}
Session 3 of the Zero-to-Hero Data Hack — from panel to causal claim to slides
:::
::::::
:::::::
...
- **Week 11 →** match + manager-change panel.
- **Week 12 →** expectation score per change.
- **Week 13 (today) →** run a **Difference-in-Differences** (DiD) analysis, explore heterogeneity (including by expectations), and present your findings.
...
A starter prompt for unpacking a DiD paper: [`did-understand-prompt.txt`](/week13/assets/did-understand-prompt.txt).
:::
...
6. **Heterogeneity** — interact treatment with manager experience, team budget, league, and **your Week 12 expectation score**.
...
## Delivery (Week 13 — end of the hack)
...
- **Who:** by **group** — the same team you started with in Week 11. Finish what you started together in the session.
- **Deadline:** **Sunday 23:55** (the Sunday after this session).
- **What:**
  - GitHub repo with: data (or fetcher), Week 11 tests, Week 12 article + expectations tables, Week 13 analysis code.
